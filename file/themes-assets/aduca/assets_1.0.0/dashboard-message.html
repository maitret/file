...
<section class="dashboard-area">
    <div class="off-canvas-menu dashboard-off-canvas-menu off--canvas-menu custom-scrollbar-styled pt-20px">
        ...
        <ul class="generic-list-item off-canvas-menu-list off--canvas-menu-list pt-35px">
            ...
            <li class="page-active"><a href="dashboard-message.html"><svg class="mr-2" xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 0 24 24" width="18px"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M12 22c1.1 0 2-.9 2-2h-4c0 1.1.9 2 2 2zm6-6v-5c0-3.07-1.63-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.64 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2zm-2 1H8v-6c0-2.48 1.51-4.5 4-4.5s4 2.02 4 4.5v6z"/></svg> Message <span class="badge badge-info p-1 ml-2">2</span></a></li>
            ...
            <div class="dashboard-message-wrapper d-flex my-4">
                <div class="message-sidebar">
                    <form action="#" class="p-4">
                        <div class="form-group mb-0">
                            <input class="form-control form--control form--control-gray pl-3" type="text" placeholder="Search...">
                        ...
                        <div class="notification-body scrolled-box scrolled--box custom-scrollbar-styled">
                            <a href="#" class="media media-card align-items-center message-active">
                                ...
                                <div class="media-body overflow-hidden">
                                    <h5 class="fs-14">Daniel Hardman</h5>
                                    <p class="text-truncate lh-18 pt-1 text-gray fs-13">How the hell am I supposed to get a jury to believe you when I am not even sure that I do</p>
                                    <span class="fs-12 d-block lh-18 pt-1 text-gray">5 min ago</span>
                                </div>
                            </a>
                            <a href="#" class="media media-card align-items-center">
                                <div class="avatar-sm flex-shrink-0 mr-2 position-relative">
                                    <img class="rounded-full img-fluid" src="images/small-avatar-1.jpg" alt="Avatar image">
                                    <span class="dot-status position-absolute bottom-0 right-0"></span>
                                </div>
                                <div class="media-body overflow-hidden">
                                    <h5 class="fs-14">Daniel Hardman <span class="badge badge-success p-1 ml-2">2</span></h5>
                                    <p class="text-truncate lh-18 pt-1 text-gray fs-13">How the hell am I supposed to get a jury to believe you when I am not even sure that I do</p>
                                    <span class="fs-12 d-block lh-18 pt-1 text-gray">5 min ago</span>
                                </div>
                            </a>
                ...
                <div class="message-content flex-grow-1">
                    <div class="message-header bg-gray d-flex align-items-center justify-content-between p-4 border-bottom border-bottom-gray">
                        ...
                        <div class="icon-element icon-element-sm shadow-sm cursor-pointer" data-toggle="tooltip" data-placement="top" title="Clear chart">
                    ...
                    <div class="conversation-wrap">
                        <div class="conversation-box custom-scrollbar-styled">
                            <div class="message-time text-center mb-3">
                                <span class="ribbon">30 Jan, 2020</span>
                            </div>
                                    ...
                                    <div class="media-body d-flex align-items-center">
                                        <div class="generic-action-wrap generic--action-wrap-3">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLinkFour">
                                        ...
                                        <div class="message-body">
                                            <h5 class="fs-13"> How the hell am I supposed to get a jury to believe you when I am not even sure that I do? 😒</h5>
                                            <span class="fs-12 d-block lh-18 pt-1">11:44 AM <i class="la la-check ml-1"></i></span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="media-body d-flex align-items-center">
                                        <div class="generic-action-wrap generic--action-wrap-3">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLinkFive">
                                                    <a class="dropdown-item" href="#">Copy</a>
                                                    <a class="dropdown-item" href="#">Cut</a>
                                                    <a class="dropdown-item" href="#">Edit</a>
                                                    <a class="dropdown-item" href="#">Delete</a>
                                        ...
                                        <div class="message-body">
                                            <h5 class="fs-13">When you're backed against the wall, break the god damn thing down.</h5>
                                            <span class="fs-12 d-block lh-18 pt-1">11:44 AM <i class="la la-check ml-1"></i></span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="media-body d-flex align-items-center">
                                        <div class="generic-action-wrap generic--action-wrap-3">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLinkSix">
                                                    <a class="dropdown-item" href="#">Copy</a>
                                                    <a class="dropdown-item" href="#">Cut</a>
                                                    <a class="dropdown-item" href="#">Edit</a>
                                                    <a class="dropdown-item" href="#">Delete</a>
                                        ...
                                        <div class="message-body">
                                            <h5 class="fs-13">Excuses don't win championships. 😐</h5>
                                            <span class="fs-12 d-block lh-18 pt-1">11:44 AM <i class="la la-check ml-1"></i></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="message-time text-center mb-3">
                                <span class="ribbon">Yesterday</span>
                            </div><!-- message-time -->
                            <div class="conversation-item message-sent mb-3">
                                <div class="media media-card align-items-center">
                                    <div class="avatar-sm flex-shrink-0 mr-4">
                                    ...
                                    <div class="media-body d-flex align-items-center">
                                        <div class="generic-action-wrap generic--action-wrap-3">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLinkSeven">
                                                    <a class="dropdown-item" href="#">Copy</a>
                                                    <a class="dropdown-item" href="#">Cut</a>
                                                    <a class="dropdown-item" href="#">Edit</a>
                                                    <a class="dropdown-item" href="#">Delete</a>
                                        ...
                                        <div class="message-body">
                                            <h5 class="fs-13">Oh yeah, you said right 👍</h5>
                                            <span class="fs-12 d-block lh-18 pt-1">11:44 AM <i class="la la-check ml-1"></i></span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="media-body d-flex align-items-center">
                                        <div class="generic-action-wrap generic--action-wrap-3">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLinkEight">
                                                    <a class="dropdown-item" href="#">Copy</a>
                                                    <a class="dropdown-item" href="#">Cut</a>
                                                    <a class="dropdown-item" href="#">Edit</a>
                                                    <a class="dropdown-item" href="#">Delete</a>
                                        ...
                                        <div class="message-body">
                                            <h5 class="fs-13">Anyway! when i will start working on your project 😎😎😎</h5>
                                            <span class="fs-12 d-block lh-18 pt-1">11:44 AM <i class="la la-check ml-1"></i></span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="media-body d-flex align-items-center">
                                        <div class="generic-action-wrap generic--action-wrap-3">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLinkNine">
                                                    <a class="dropdown-item" href="#">Copy</a>
                                                    <a class="dropdown-item" href="#">Cut</a>
                                                    <a class="dropdown-item" href="#">Edit</a>
                                                    <a class="dropdown-item" href="#">Delete</a>
                                        ...
                                        <div class="message-body">
                                            <h5 class="fs-13">You can start working on project tomorrow 🙂</h5>
                                            <span class="fs-12 d-block lh-18 pt-1">11:44 AM <i class="la la-check ml-1"></i></span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="media-body d-flex align-items-center">
                                        <div class="generic-action-wrap generic--action-wrap-3">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLinkTen">
                                                    <a class="dropdown-item" href="#">Copy</a>
                                                    <a class="dropdown-item" href="#">Cut</a>
                                                    <a class="dropdown-item" href="#">Edit</a>
                                                    <a class="dropdown-item" href="#">Delete</a>
                            ...
                            <div class="conversation-item message-reply mb-3">
                                <div class="media media-card align-items-center">
                                    ...
                                    <div class="media-body d-flex align-items-center">
                                        ...
                                        <div class="message-body">
                                            <h5 class="fs-13">Hi John, I just wanted to let you know that project is finished</h5>
                                            <span class="fs-12 d-block lh-18 pt-1">11:44 AM <i class="la la-check ml-1"></i></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="conversation-item message-sent mb-3">
                                <div class="media media-card align-items-center">
                                    ...
                                    <div class="media-body d-flex align-items-center">
                                        ...
                                        <div class="message-body">
                                            <h5 class="fs-13">Hi Daniel! I'm actually on vacation 🏖️ until Sunday so I can't check it now 😎</h5>
                                            <span class="fs-12 d-block lh-18 pt-1">11:44 AM <i class="la la-check ml-1"></i></span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="message-reply-body d-flex align-items-center pt-2 px-4 border-top border-top-gray">
                        <form action="#" class="flex-grow-1">
                            <textarea class="emoji-picker" placeholder="Your message" rows="3"></textarea>
                        </form>
                        ...
                        <button type="button" class="message-send icon-element icon-element-xs bg-1 text-white ml-2 border-0">
