                        ...
                        <div class="menu-wrapper">
                            ...
                            <div class="nav-right-button border-left border-left-gray pl-4 mr-3">
                                <ul class="generic-list-item">
                                    ...
                                    <li>Or</li>
                                    <li><a href="sign-up.html" class="btn theme-btn theme-btn-sm text-white"><i class="la la-user-plus mr-1"></i> Register</a></li>
                                </ul>
                ...
                <div class="col-lg-7">
                    <div class="hero-content">
                        <div class="section-heading">
                            ...
                            <p class="section__desc text-white pb-4">Who tells you can’t do it? Build the confidence, skills, and qualifications to take control of your future. Start one of our 1000 high quality courses from the world’s leading experts today!</p>
                        </div><!-- end section-heading -->
                        <form method="post" class="w-75 pt-2">
                            <label class="label-text bg-white rounded py-1 px-2 fs-14 font-weight-medium lh-20">What do you want to learn?</label>
                            <div class="form-group mb-0">
                                <input class="form-control form--control pl-3" type="text" name="search" placeholder="Search courses by keywords">
...
<section class="get-started-area section--padding position-relative">
    <div class="container">
        <div class="section-heading text-center">
            <h2 class="section__title">Why Study with Aduca</h2>
        </div><!-- end section-heading -->
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item text-center shadow-none rounded-0 bg-transparent">
                    <div class="card-body p-0">
                        ...
                        <h5 class="card-title pt-4 pb-2">Learn anything</h5>
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item text-center shadow-none rounded-0 bg-transparent">
                    <div class="card-body p-0">
                        ...
                        <h5 class="card-title pt-4 pb-2">Flexible learning</h5>
                        <p class="card-text">Phasellus enim magna, varius et commodo ut, ultricies vitae velit. Ut nulla tellus</p>
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-4 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item text-center shadow-none rounded-0 bg-transparent">
                    <div class="card-body p-0">
                        ...
                        <h5 class="card-title pt-4 pb-2">Learn with experts</h5>
                        <p class="card-text">Phasellus enim magna, varius et commodo ut, ultricies vitae velit. Ut nulla tellus</p>
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-4 -->
...
<section class="category-area bg-gray section-padding text-center">
    <div class="container">
                ...
                <div class="flip-box">
                    <div class="flip-box-front">
                        ...
                        <a href="#" class="flip-content d-flex align-items-center justify-content-center">
                            <div>
                                <h3 class="flip-title mb-1">Web Development</h3>
                                <p class="flip-subtitle">200 Courses</p>
                            </div>
                        </a><!-- end flip-content -->
                    ...
                    <div class="flip-box-back">
                        ...
                        <a href="#" class="flip-content d-flex align-items-center justify-content-center">
                            <div>
                                ...
                                <h3 class="flip-title">View Courses</h3>
                            </div>
                        </a><!-- end flip-content -->
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="flip-box">
                    <div class="flip-box-front">
                        ...
                        <a href="#" class="flip-content d-flex align-items-center justify-content-center">
                            <div>
                                <h3 class="flip-title mb-1">Business</h3>
                                <p class="flip-subtitle">689 Courses</p>
                            </div>
                        </a><!-- end flip-content -->
                    </div><!-- end flip-box-front -->
                    <div class="flip-box-back">
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="flip-box">
                    <div class="flip-box-front">
                        ...
                        <a href="#" class="flip-content d-flex align-items-center justify-content-center">
                            <div>
                                <h3 class="flip-title mb-1">Technology</h3>
                                <p class="flip-subtitle">567 Courses</p>
                            </div>
                        </a><!-- end flip-content -->
                    </div><!-- end flip-box-front -->
                    <div class="flip-box-back">
            ...
            <div class="col-lg-3 responsive-column-half">
                <div class="flip-box">
                    <div class="flip-box-front">
                        ...
                        <a href="#" class="flip-content d-flex align-items-center justify-content-center">
                            <div>
                                <h3 class="flip-title mb-1">Marketing</h3>
                                <p class="flip-subtitle">200 Courses</p>
                            </div>
                        </a><!-- end flip-content -->
                    </div><!-- end flip-box-front -->
            ...
            <div class="col-lg-3 responsive-column-half">
                <div class="flip-box">
                    <div class="flip-box-front">
                        ...
                        <a href="#" class="flip-content d-flex align-items-center justify-content-center">
                            <div>
                                <h3 class="flip-title mb-1">Health</h3>
                                <p class="flip-subtitle">689 Courses</p>
                            </div>
                        </a><!-- end flip-content -->
                    </div><!-- end flip-box-front -->
            ...
            <div class="col-lg-3 responsive-column-half">
                <div class="flip-box">
                    <div class="flip-box-front">
                        ...
                        <a href="#" class="flip-content d-flex align-items-center justify-content-center">
                            <div>
                                <h3 class="flip-title mb-1">Architecture</h3>
                                <p class="flip-subtitle">567 Courses</p>
                            </div>
                        </a><!-- end flip-content -->
                    </div><!-- end flip-box-front -->
            ...
            <div class="col-lg-3 responsive-column-half">
                <div class="flip-box">
                    <div class="flip-box-front">
                        ...
                        <a href="#" class="flip-content d-flex align-items-center justify-content-center">
                            <div>
                                <h3 class="flip-title mb-1">Data Science</h3>
                                <p class="flip-subtitle">567 Courses</p>
                            </div>
                        </a><!-- end flip-content -->
                    </div><!-- end flip-box-front -->
        ...
        <div class="view-more-box pt-4 text-center">
            <a href="categories.html" class="btn theme-btn">View all Category <i class="la la-arrow-right icon ml-1"></i></a>
        </div><!-- end view-more-box -->
    </div><!-- end container -->
...
<section class="cat-area section-padding img-bg">
    ...
    <div class="container">
        <div class="cta-content-wrap text-center position-relative">
            <div class="section-heading">
                <h2 class="section__title fs-40 lh-60 text-white">Why so late? Start one of our 2000 high quality courses
                    from the world's leading experts today!</h2>
            </div><!-- end section-heading -->
            <div class="cat-btn-box mt-35px">
                <a href="sign-up.html" class="btn theme-btn theme-btn-white">Get Started <i class="la la-arrow-right icon ml-1"></i></a>
            </div><!-- end cat-btn-box -->
        ...
        <div class="row">
                ...
                <div class="card card-item hover-y">
                    <div class="card-body d-flex align-items-center">
                        <div class="flex-shrink-0">
                            <img src="images/small-img-2.jpg" alt="card image" class="img-fluid rounded-full">
                        </div>
                        <div class="pl-4">
                            <h5 class="card-title pt-4 pb-2">Become an Instructor</h5>
                            <p class="card-text">Students practice at their own pace, first filling in gaps in their understanding and then accelerating</p>
                            <div class="btn-box mt-20px">
                                <a href="become-a-teacher.html" class="btn theme-btn theme-btn-sm lh-30"><i class="la la-user mr-1"></i>Start Teaching</a>
                            </div><!-- end btn-box -->
                        </div>
                    </div><!-- end card-body -->
                </div><!-- end card -->
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-y">
                    <div class="card-body d-flex align-items-center">
                        <div class="flex-shrink-0">
                            <img src="images/small-img-3.jpg" alt="card image" class="img-fluid rounded-full">
                        </div>
                        <div class="pl-4">
                            <h5 class="card-title pt-4 pb-2">Become a Partner</h5>
                            <p class="card-text">Created by experts, Coursector library of trusted practice and lessons covers math, science, and more.</p>
                            <div class="btn-box mt-20px">
                                <a href="for-business.html" class="btn theme-btn theme-btn-sm lh-30"><i class="la la-briefcase mr-1"></i>Get Aduca for Business</a>
                            </div><!-- end btn-box -->
                        </div>
                    </div><!-- end card-body -->
                </div><!-- end card -->
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-y">
                    <div class="card-body d-flex align-items-center">
                        <div class="flex-shrink-0">
                            <img src="images/small-img-4.jpg" alt="card image" class="img-fluid rounded-full">
                        </div>
                        <div class="pl-4">
                            <h5 class="card-title pt-4 pb-2">Become a Learner</h5>
                            <p class="card-text">Created by experts, Coursector library of trusted practice and lessons covers math, science, and more.</p>
                            <div class="btn-box mt-20px">
                                <a href="admission.html" class="btn theme-btn theme-btn-sm lh-30"><i class="la la-file-text-o mr-1"></i>Start Learning</a>
                            </div><!-- end btn-box -->
                        </div>
                    </div><!-- end card-body -->
                </div><!-- end card -->
