    ...
    <div class="dashboard-content-wrap">
        ...
        <div class="container-fluid">
            ...
            <div class="dashboard-heading mb-5">
                <h3 class="fs-22 font-weight-semi-bold">Withdraw</h3>
            </div>
            <div class="Withdraw-info mb-5">
                <ul class="generic-list-item">
                    <li><h3 class="fs-18 font-weight-semi-bold">Current Balance</h3></li>
                    <li>Your current balance is <span class="text-black font-weight-semi-bold">$219.20 </span> ready to withdraw</li>
                    <li><a href="#" class="badge btn-primary p-1 text-white d-inline-block">Make a withdraw</a></li>
                    <li>You will get paid by <span class="text-black">Bank Transfer</span>, You can change your <a href="#" class="text-color">withdraw preference </a></li>
                </ul>
                <ul class="generic-list-item">
                    <li><h3 class="fs-18 font-weight-semi-bold">Pending withdrawals</h3></li>
