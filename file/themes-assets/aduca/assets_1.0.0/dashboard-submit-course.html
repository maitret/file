...
<section class="dashboard-area">
    <div class="off-canvas-menu dashboard-off-canvas-menu off--canvas-menu custom-scrollbar-styled pt-20px">
        ...
        <ul class="generic-list-item off-canvas-menu-list off--canvas-menu-list pt-35px">
            ...
            <li class="page-active"><a href="dashboard-submit-course.html"><svg class="mr-2" xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 0 24 24" width="18px"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg> Submit Course</a></li>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control form--control pl-3" type="text" name="text" placeholder="e.g. Learn JavaScript for Beginners ">
                                </div>
                            </div><!-- end col-lg-12 -->
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="label-text">Course Subtitle</label>
                                    <input class="form-control form--control pl-3" type="text" name="text" placeholder="e.g. Empower yourself with this comprehensive JavaScript course.">
                                </div>
                            </div><!-- end col-lg-12 -->
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="label-text">Instructor's Name</label>
                                    <input class="form-control form--control pl-3" type="text" name="text" placeholder="Your name">
                                </div>
                            </div><!-- end col-lg-12 -->
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="label-text">Course Category</label>
                                    <input class="form-control form--control tags-input" type="text" name="text" placeholder="e.g. Javascript">
                                </div>
                            </div><!-- end col-lg-12 -->
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="label-text">Total Class</label>
                                    <input class="form-control form--control pl-3" type="text" name="text" placeholder="Total courses">
                                </div>
                            </div><!-- end col-lg-12 -->
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="label-text">Course Hours</label>
                                    <input class="form-control form--control pl-3" type="text" name="text" placeholder="e.g. 30">
                                </div>
                            </div><!-- end col-lg-12 -->
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="label-text">Course Price</label>
                                    <input class="form-control form--control pl-3" type="text" name="text" placeholder="e.g. 79">
                                </div>
                            </div><!-- end col-lg-12 -->
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="label-text">Course Language</label>
                                    <input class="form-control form--control pl-3" type="text" name="text" placeholder="e.g. English">
                                </div>
                            </div><!-- end col-lg-12 -->
                            <div class="col-lg-12">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control form--control user-text-editor pl-3" name="message">Write course description here</textarea>
                                </div>
                            </div><!-- end col-lg-12 -->
                            <div class="col-lg-12">
                                <div class="form-group mb-0">
                                    ...
                                    <div class="file-upload-wrap">
                                        ...
                                        <span class="file-upload-text"><i class="la la-cloud-upload mr-2 fs-18"></i>Drop files here or click to upload.</span>
                                    </div><!-- file-upload-wrap -->
                                </div>
                            </div><!-- end col-lg-12 -->
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control form--control pl-3" type="text" name="text" placeholder="Video title">
                                </div>
                            </div><!-- end col-lg-4 -->
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="label-text">Video Category</label>
                                    <input class="form-control form--control pl-3" type="text" name="text" placeholder="Video category">
                                </div>
                            </div><!-- end col-lg-4 -->
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="label-text">Video URL</label>
                                    <input class="form-control form--control pl-3" type="text" name="text" placeholder="Video URL">
                                </div>
                            </div><!-- end col-lg-4 -->
                        </div>
                    </div><!-- end card-body -->
