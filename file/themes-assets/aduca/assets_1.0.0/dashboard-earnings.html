...
<section class="dashboard-area">
    <div class="off-canvas-menu dashboard-off-canvas-menu off--canvas-menu custom-scrollbar-styled pt-20px">
        ...
        <ul class="generic-list-item off-canvas-menu-list off--canvas-menu-list pt-35px">
            ...
            <li class="page-active"><a href="dashboard-earnings.html"><svg class="mr-2" xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 0 24 24" width="18px"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M11.8 10.9c-2.27-.59-3-1.2-3-2.15 0-1.09 1.01-1.85 2.7-1.85 1.78 0 2.44.85 2.5 2.1h2.21c-.07-1.72-1.12-3.3-3.21-3.81V3h-3v2.16c-1.94.42-3.5 1.68-3.5 3.61 0 2.31 1.91 3.46 4.7 4.13 2.5.6 3 1.48 3 2.41 0 .69-.49 1.79-2.7 1.79-2.06 0-2.87-.92-2.98-2.1h-2.2c.12 2.19 1.76 3.42 3.68 3.83V21h3v-2.15c1.95-.37 3.5-1.5 3.5-3.55 0-2.84-2.43-3.81-4.7-4.4z"/></svg> Earnings</a></li>
    ...
    <div class="dashboard-content-wrap">
        ...
        <div class="container-fluid">
            ...
            <div class="dashboard-heading mb-5">
                <h3 class="fs-22 font-weight-semi-bold">Earnings</h3>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 responsive-column-half">
                            <div class="card card-item dashboard-info-card">
                                <div class="card-body d-flex align-items-center">
                                    ...
                                    <div class="pl-4">
                                        <p class="card-text fs-18">All time withdraws</p>
                        ...
                        <div class="col-lg-4 responsive-column-half">
                            <div class="card card-item dashboard-info-card">
                                <div class="card-body d-flex align-items-center">
                                    ...
                                    <div class="pl-4">
                                        <p class="card-text fs-18">Deducted Commissions</p>
                        ...
                        <div class="col-lg-4 responsive-column-half">
                            <div class="card card-item dashboard-info-card">
                                <div class="card-body d-flex align-items-center">
                                    ...
                                    <div class="pl-4">
                                        <p class="card-text fs-18">Deducted Fees</p>
                        ...
                        <div class="col-lg-6 responsive-column-half">
                            <div class="card card-item">
                                <div class="card-body">
                                    <h3 class="fs-18 font-weight-semi-bold pb-4">Earning Chart for this month (July)</h3>
                ...
                <div class="tab-pane fade" id="report" role="tabpanel" aria-labelledby="report-tab">
                    <div class="data-list d-flex flex-wrap align-items-center justify-content-between pb-40px">
                        <div class="btn-group btn--group btn-group-toggle flex-wrap" data-toggle="buttons">
                            <label class="btn theme-btn theme-btn-transparent shadow-none fs-15 font-weight-medium">
                                <input type="radio" name="options" id="option1"> Last Year
                            </label>
                            <label class="btn theme-btn theme-btn-transparent shadow-none fs-15 font-weight-medium active">
                                <input type="radio" name="options" id="option2" checked> This Year
                            </label>
                            <label class="btn theme-btn theme-btn-transparent shadow-none fs-15 font-weight-medium">
                                <input type="radio" name="options" id="option3"> Last Month
                            </label>
                            <label class="btn theme-btn theme-btn-transparent shadow-none fs-15 font-weight-medium">
                                <input type="radio" name="options" id="option4"> Last Week
                            </label>
                            <label class="btn theme-btn theme-btn-transparent shadow-none fs-15 font-weight-medium">
                                <input type="radio" name="options" id="option5"> This Week
                            </label>
                        </div>
                        <form action="#" class="d-flex align-items-center">
                            <div class="form-group mb-0 flex-shrink-0 mr-2">
                                <span class="la la-calendar-o input-icon"></span>
                                <input class="form-control form--control datepicker" type="text" value="04/4/2020">
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="card card-item">
                                <div class="card-body">
                                    <h3 class="fs-18 font-weight-semi-bold pb-4">Earning Data for the year of (2019)</h3>
                            ...
                            <tr>
                                <th scope="row">
                                    <ul class="generic-list-item pb-3">
                                        ...
                                        <li>
                                            <span class="text-black mr-1">Date:</span>July 4, 2020, 11:30am
                                        </li>
                                        <li>
                                            <span class="text-black mr-1">Tutorial:</span>Creating Responsive SVG
                                        </li>
                                        <li>
                                            <span class="text-black mr-1">Price:</span>$79.00
                                        </li>
                                        <li>
                                            <span class="text-black mr-1">Order ID:</span>#090909
                                        </li>
                                    </ul>
                                    <ul class="generic-list-item">
                                        <li>
                                            <span class="text-black font-weight-semi-bold">Purchaser</span>
                                        </li>
                                        <li>
                                            <span class="text-black mr-1">Name:</span>Kamran Adi
                                        </li>
                                        <li>
                                            <span class="text-black mr-1">Address:</span>329 Queensberry Street, North Melbourne VIC 3051, Australia.
                                        </li>
                                        <li>
                                            <span class="text-black mr-1">Email:</span>kamranadi@gmail.com
                                        </li>
                                    </ul>
                                </th>
                                <td>
                                    <ul class="generic-list-item">
                                        <li class="text-black">$55.00</li>
                                        <li>As per 70.00</li>
                                        <li>(Percent)</li>
                                    </ul>
                                </td>
                                ...
                                <td>
                                    <ul class="generic-list-item">
                                        <li class="text-black">Maintenance</li>
                                        <li class="text-black">Fees: $12.00</li>
                                        <li>Type: Fixed</li>
                                    </ul>
                                </td>
                            </tr>
