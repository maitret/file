...
<section class="dashboard-area">
    <div class="off-canvas-menu dashboard-off-canvas-menu off--canvas-menu custom-scrollbar-styled pt-20px">
        ...
        <ul class="generic-list-item off-canvas-menu-list off--canvas-menu-list pt-35px">
            ...
            <li class="page-active"><a href="dashboard-purchase-history.html"><svg class="mr-2" xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 0 24 24" width="18px"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M15.55 13c.75 0 1.41-.41 1.75-1.03l3.58-6.49c.37-.66-.11-1.48-.87-1.48H5.21l-.94-2H1v2h2l3.6 7.59-1.35 2.44C4.52 15.37 5.48 17 7 17h12v-2H7l1.1-2h7.45zM6.16 6h12.15l-2.76 5H8.53L6.16 6zM7 18c-1.1 0-1.99.9-1.99 2S5.9 22 7 22s2-.9 2-2-.9-2-2-2zm10 0c-1.1 0-1.99.9-1.99 2s.89 2 1.99 2 2-.9 2-2-.9-2-2-2z"/></svg> Purchase History</a></li>
    ...
    <div class="dashboard-content-wrap">
        ...
        <div class="container-fluid">
            ...
            <div class="table-responsive mb-5">
                ...
                <table class="table generic-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <ul class="generic-list-item">
                                <li class="font-weight-semi-bold text-black fs-18">Total:</li>
                            </ul>
                        </td>
                        <td>
                            <ul class="generic-list-item">
                                <li class="font-weight-semi-bold text-black fs-18">$158</li>
                            </ul>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <ul class="generic-list-item">
                                <li class="font-weight-semi-bold text-black fs-18">Total Paid:</li>
                            </ul>
                        </td>
                        <td>
                            <ul class="generic-list-item">
            ...
            <div class="table-responsive">
                <h3 class="fs-18 font-weight-semi-bold pb-4">Refunds Details</h3>
                <table class="table generic-table">
                    <thead>
                    <tr>
