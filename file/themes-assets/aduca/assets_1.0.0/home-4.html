            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="header-widget d-flex flex-wrap align-items-center justify-content-end">
                        <div class="theme-picker d-flex align-items-center border-right border-right-gray mr-3 pr-3">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-3">
                        <div class="logo-box justify-content-between">
                            ...
                            <div class="menu-category border-left border-left-gray pl-4">
                                <ul>
                                    <li>
                    ...
                    <div class="col-lg-9">
                        <div class="menu-wrapper">
                                                ...
                                                <li class="col-lg-3">
                                                    <div class="menu-banner position-relative h-100">
                                                        ...
                                                        <div class="menu-banner-content p-4 position-absolute bottom-0 left-0">
                                                            <h4 class="fs-20 font-weight-bold pb-3 text-white lh-26">Try Aduca free for one month</h4>
                            ...
                            <div class="nav-right-button">
                                <a href="login.html" class="btn theme-btn theme-btn-sm lh-26 theme-btn-transparent mr-2"><i class="la la-sign-in mr-1"></i> Login</a>
                                <a href="sign-up.html" class="btn theme-btn theme-btn-sm lh-26 shadow-none"><i class="la la-plus mr-1"></i> Sign up</a>
       ...
       <div class="container">
           <div class="hero-content text-center">
               <div class="section-heading">
                   <h2 class="section__title fs-60 lh-80 pb-3 theme-font-2">The latest digital skills, <br> within reach.</h2>
                   <p class="section__desc pb-5">Discover the fastest, most effective way to gain job-ready <br> expertise for the careers of the future.</p>
               </div><!-- end section-heading -->
               <form method="post" class="w-50 mx-auto">
                   <div class="form-group mb-0">
                       <input class="form-control form--control pl-3 shadow-sm border-0" type="text" name="search" placeholder="What do you wnat to learn?">
        ...
        <div class="row">
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box info--box hover-y">
                    ...
                    <h3 class="info__title theme-font-2 font-weight-bold">Unlimited Access</h3>
                    <p class="info__text">Choose what you’d like to learn from our extensive subscription library</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box info--box hover-y">
                    ...
                    <h3 class="info__title theme-font-2 font-weight-bold">Expert Instructors</h3>
                    <p class="info__text">Learn from industry experts who are passionate about teaching</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box info--box hover-y">
                    ...
                    <p class="info__text">Switch between your computer or mobile device</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
        </div><!-- end row -->
    </div><!-- end container -->
            ...
            <div class="featured-course-carousel owl-action-styled owl--action-styled">
                <div class="card card-item card-item-list-layout border border-gray shadow-none">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title pb-1"><a href="course-details.html">Django with React | An Ecommerce Website</a></h5>
                        <p class="card-text lh-24 pb-1">Build an eCommerce platform from the ground up with React, Redux, Django & Postgres</p>
                        <p class="card-text fs-15 font-weight-regular">By <a href="teacher-detail.html">Jose Portilla</a> and 1 other</p>
                        <div class="d-flex flex-wrap align-items-center fs-14">
                            <p class="text-success font-weight-medium pb-2 mr-2">Updated<span class="font-weight-bold pl-1">November 2020</span></p>
                            <ul class="generic-list-item generic-list-item-bullet generic-list-item--bullet d-flex align-items-center fs-14">
                                <li>23 total hours</li>
                                <li>All Levels</li>
                            </ul>
                        </div>
                        <div class="rating-wrap d-flex align-items-center pb-2">
                ...
                <div class="card card-item card-item-list-layout border border-gray shadow-none">
                    ...
                    <div class="card-body">
                        <h6 class="ribbon ribbon-blue-bg fs-14 mb-3">Intermediate</h6>
                        <h5 class="card-title pb-1"><a href="course-details.html">Python for Data Science and Machine Learning Bootcamp</a></h5>
                        <p class="card-text lh-24 pb-1">Learn how to use NumPy, Pandas, Seaborn , Matplotlib , Plotly , Scikit-Learn , Machine Learning, Tensorflow , and more!</p>
                        <p class="card-text fs-15 font-weight-regular">By <a href="teacher-detail.html">Jose Portilla</a></p>
                        <div class="d-flex flex-wrap align-items-center fs-14">
                            <p class="text-success font-weight-medium pb-2 mr-2">Updated<span class="font-weight-bold pl-1">November 2020</span></p>
                            <ul class="generic-list-item generic-list-item-bullet generic-list-item--bullet d-flex align-items-center fs-14">
                                <li>23 total hours</li>
                ...
                <div class="card card-item card-item-list-layout border border-gray shadow-none">
                    ...
                    <div class="card-body">
                        <h6 class="ribbon ribbon-blue-bg fs-14 mb-3">All Levels</h6>
                        <h5 class="card-title pb-1"><a href="course-details.html">Java Programming Masterclass for Software Developers</a></h5>
                        <p class="card-text lh-24 pb-1">Learn Java In This Course And Become a Computer Programmer. Obtain valuable Core Java Skills And Java Certification</p>
                        <p class="card-text fs-15 font-weight-regular">By <a href="teacher-detail.html">Jose Portilla</a> and 1 other</p>
                        <div class="d-flex flex-wrap align-items-center fs-14">
                            <p class="text-success font-weight-medium pb-2 mr-2">Updated<span class="font-weight-bold pl-1">November 2020</span></p>
                            <ul class="generic-list-item generic-list-item-bullet generic-list-item--bullet d-flex align-items-center fs-14">
...
<!--======================================
        START CATEGORY AREA
======================================-->
<section class="category-area section--padding position-relative overflow-hidden">
    ...
    <div class="container">
        <div class="section-heading category-content-wrap text-center">
            <h5 class="mb-2 text-color fs-16">Browse by Categories</h5>
            <h2 class="section__title theme-font-2">Popular Topics to Learn</h2>
        </div><!-- end section-heading -->
        <div class="category-carousel owl-action-styled owl--action-styled mt-60px">
            <div class="category-item category-item-layout-2">
                <a href="#" class="category-content">
                    ...
                    <h3 class="cat__title pb-3">Development</h3>
                    <p class="cat__text text-gray">40 Courses</p>
            ...
            <div class="category-item category-item-layout-2">
                <a href="#" class="category-content">
                    ...
                    <h3 class="cat__title pb-3">Business</h3>
                    <p class="cat__text text-gray">40 Courses</p>
                </a><!-- end category-content -->
            </div><!-- end category-item -->
            <div class="category-item category-item-layout-2">
                <a href="#" class="category-content">
                    ...
                    <h3 class="cat__title pb-3">Design</h3>
                    <p class="cat__text text-gray">40 Courses</p>
                </a><!-- end category-content -->
            </div><!-- end category-item -->
            <div class="category-item category-item-layout-2">
                <a href="#" class="category-content">
                    ...
                    <h3 class="cat__title pb-3">IT & Software</h3>
                    <p class="cat__text text-gray">40 Courses</p>
                </a><!-- end category-content -->
            </div><!-- end category-item -->
            <div class="category-item category-item-layout-2">
                <a href="#" class="category-content">
                    ...
                    <h3 class="cat__title pb-3">Photography</h3>
                    <p class="cat__text text-gray">40 Courses</p>
                </a><!-- end category-content -->
            </div><!-- end category-item -->
            <div class="category-item category-item-layout-2">
                <a href="#" class="category-content">
                    ...
                    <h3 class="cat__title pb-3">Marketing</h3>
                    <p class="cat__text text-gray">40 Courses</p>
                </a><!-- end category-content -->
            </div><!-- end category-item -->
            <div class="category-item category-item-layout-2">
                <a href="#" class="category-content">
                    <div class="icon-element icon-element-md shadow-sm text-color-7">
                        <i class="la la-music"></i>
                    </div>
                    <h3 class="cat__title pb-3">Music</h3>
                    <p class="cat__text text-gray">40 Courses</p>
                </a><!-- end category-content -->
            </div><!-- end category-item -->
            <div class="category-item category-item-layout-2">
                <a href="#" class="category-content">
                    <div class="icon-element icon-element-md shadow-sm text-color-8">
                        <i class="la la-medkit"></i>
                    </div>
                    <h3 class="cat__title pb-3">Health & Fitness</h3>
                    <p class="cat__text text-gray">40 Courses</p>
                </a><!-- end category-content -->
            </div><!-- end category-item -->
        </div><!-- end category-carousel-->
    </div><!-- end container -->
...
<section class="course-area section-padding bg-gray">
    <div class="container">
        <div class="section-heading text-center">
            <h2 class="section__title theme-font-2 pb-40px">Courses to get you started</h2>
        </div><!-- end section-heading -->
...
<section class="benefit-area section--padding">
    <div class="course-wrapper">
        <div class="container">
            <div class="section-heading text-center">
                <h2 class="section__title theme-font-2 pb-3">Don't waste your valuable time or money</h2>
                ...
                <div class="col-lg-3 responsive-column-half">
                    <div class="info-box info--box info--box-2 hover-s border-red">
                        <div class="icon-element icon-element-md bg-1">
                            <svg class="svg-icon-color-white" width="30" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512" xml:space="preserve">
                                <g>
                                    <g>
                        ...
                        <h3 class="info__title theme-font-2 font-weight-bold fs-20 lh-28">Get real employable skills</h3>
                        <p class="info__text">There are many variations of passages of Lorem Ipsum available <p>
                    </div><!-- end info-box -->
                </div><!-- end col-lg-3 -->
                <div class="col-lg-3 responsive-column-half">
                    <div class="info-box info--box info--box-2 hover-s border-purple">
                        <div class="icon-element icon-element-md bg-2">
                            <svg class="svg-icon-color-white" width="30" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 432.4 432.4" xml:space="preserve">
                                <g>
                                    <g>
                                        <g>
                        ...
                        <h3 class="info__title theme-font-2 font-weight-bold fs-20 lh-28">Project-based, active learning</h3>
                        <p class="info__text">There are many variations of passages of Lorem Ipsum available <p>
                    </div><!-- end info-box -->
                </div><!-- end col-lg-3 -->
                <div class="col-lg-3 responsive-column-half">
                    <div class="info-box info--box info--box-2 hover-s border-yellow">
                        <div class="icon-element icon-element-md bg-3">
                            <svg class="svg-icon-color-white" width="28" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512"  xml:space="preserve">
                            <g>
                                <g>
                                    <g>
                                        <path d="M458.406,380.681c-8.863-6.593-21.391-4.752-27.984,4.109c-3.626,4.874-7.506,9.655-11.533,14.21
                        ...
                        <h3 class="info__title theme-font-2 font-weight-bold fs-20 lh-28">Learn on your schedule</h3>
                        <p class="info__text">There are many variations of passages of Lorem Ipsum available <p>
                    </div><!-- end info-box -->
                </div><!-- end col-lg-3 -->
                <div class="col-lg-3 responsive-column-half">
...
<!-- ================================
       START FUNFACT AREA
================================= -->
<section class="funfact-area text-center overflow-hidden pb-80px dot-bg">
    <div class="container">
        <div class="section-heading text-center">
        ...
        <div class="row pt-50px">
            <div class="col-lg-4 responsive-column-half">
                <div class="counter-item">
                    <div class="counter__icon icon-element mb-4 shadow-sm">
                    ...
                    <h4 class="counter__title text-color-2 fs-30 mb-3">100,000+</h4>
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="counter-item">
                    <div class="counter__icon icon-element mb-4 shadow-sm">
                        <svg class="svg-icon-color-2" width="42" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 490.667 490.667" xml:space="preserve">
                                    <g>
                                        <g>
                                            <path d="M245.333,85.333c-41.173,0-74.667,33.493-74.667,74.667s33.493,74.667,74.667,74.667S320,201.173,320,160
                                                C320,118.827,286.507,85.333,245.333,85.333z M245.333,213.333C215.936,213.333,192,189.397,192,160
                    ...
                    <h4 class="counter__title text-color-3 fs-30 mb-3">220+</h4>
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="counter-item">
                    <div class="counter__icon icon-element mb-4 shadow-sm">
                        <svg class="svg-icon-color-3" width="42" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 480.1 480.1" xml:space="preserve">
                        <g>
                            <g>
                    ...
                    <h4 class="counter__title text-color-4 fs-30 mb-3">120+</h4>
...
<section class="cat-area pt-80px pb-80px bg-radial-gradient-gray">
    <div class="container">
        <div class="cta-content-wrap text-center">
            <div class="section-heading">
                <h2 class="section__title fs-45 lh-55 theme-font-2 pb-4">Make the most of your online <br> learning experience</h2>
                <p class="section__desc">Our Online Learning Resource Center has tips, tricks and inspiring stories
                    <br> to help you learn while staying home.</p>
            </div><!-- end section-heading -->
            <div class="cat-btn-box mt-28px">
                <a href="admission.html" class="btn theme-btn">Explore Resources <i class="la la-arrow-right icon ml-1"></i></a>
            </div><!-- end cat-btn-box -->
        ...
        <div class="testimonial-carousel-3 owl-action-styled owl--action-styled mt-35px">
            <div class="card card-item border border-gray shadow-none">
                <div class="card-body">
                    ...
                    <h3 class="card-title pb-2">Great courses!</h3>
            ...
            <div class="card card-item border border-gray shadow-none">
                <div class="card-body">
                    ...
                    <h3 class="card-title pb-2">Customer support!</h3>
                    <p class="card-text pb-4">
                        My children and I LOVE Aduca! The courses are fantastic and the
                        instructors are so fun and knowledgeable.
                        I only wish we found it sooner.
            ...
            <div class="card card-item border border-gray shadow-none">
                <div class="card-body">
                    <div class="avatar-md mb-4">
                        <img src="images/small-avatar-6.jpg" alt="Testimonial avatar" class="rounded-full">
                    </div>
                    <h3 class="card-title pb-2">Customer support!</h3>
                    <p class="card-text pb-4">
                        My children and I LOVE Aduca! The courses are fantastic and the
...
<section class="client-logo-area section-padding position-relative overflow-hidden text-center">
    ...
    <div class="container">
        <div class="section-heading">
            <h2 class="section__title theme-font-2 pb-4">Trusted by companies of all sizes</h2>
        </div><!-- end section-heading -->
...
<section class="cat-area pt-80px pb-80px bg-radial-gradient-gray">
    <div class="container">
        <div class="cta-content-wrap text-center">
            <div class="section-heading">
                <h2 class="section__title lh-50 theme-font-2 pb-4">Give your team a faster way <br> to learn and apply new skills.</h2>
                <p class="section__desc">Get unlimited access to 5,000+ of Aduca’s top courses for your team.</p>
            </div><!-- end section-heading -->
            <div class="cat-btn-box mt-28px">
                <a href="for-business.html" class="btn theme-btn">Buy for my team <i class="la la-arrow-right icon ml-1"></i></a>
            </div><!-- end cat-btn-box -->
        </div><!-- end cta-content-wrap -->
    </div><!-- end container -->
        ...
        <div class="row">
            <div class="col-lg-3 responsive-column-half">
                <div class="footer-item">
                    ...
                    <div class="select-container w-auto select-container-sm">
