...
/* db_stitch.collection('historial').updateOne({owner_id: client_stitch.auth.user.id}, { $set: {
usuario:"<?php echo $Data_Usuario; ?>",url: url ,ip: "<?php echo ip(); ?>",user_agent:"<?php echo user_agent(); ?>",fecha_hora:"<?php echo date('m-d-Y H:i:s'); ?>"
} } , { upsert:true }); */
